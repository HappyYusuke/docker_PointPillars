...
ros2 launch pp_infer pp_infer_launch.py
cd ros2_bags
ros2 bag play lidar_data_three_personcd
cd
cd ros2_bags
ros2 bag play lidar_data_three_person
ros2 run follow_me_by_3d_lidar detection_3d_array_rviz
...
git glone https://github.com/zhulf0804/PointPillars.git
...
rm -rf PointPillars/
ls
vim setup_pointpillars.sh
vim .bashrc 
vim setup_pointpillars.sh 
ls
sudo chmod +x setup_pointpillars.sh 
chmod +x setup_pointpillars.sh 
ls
./setup_pointpillars.sh 
ls
vim setup_datasets.sh
cat setup_
cat setup_pointpillars.sh 
vim setup_datasets.sh 
...
cd ../
ls
rm -rf training/ testing/ data_object_label_2.zip data_object_calib.zip 
ls
vim setup_datasets.sh 
./setup_datasets.sh 
ls
